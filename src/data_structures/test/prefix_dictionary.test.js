  ...
  describe(PrefixDictionary, () => {
    ...
    describe("lookupCode", () => {
      it("finds a word matching the code", () => {
        ...
        verifyLookupResults(pd.lookupCode("ada"), ["ada"]);
      });
      ...
      it("finds all words matching the code", () => {
        ...
        verifyLookupResults(pd.lookupCode("ada"), ["ada", "ADA", "AdA"]);
      });
      ...
      it("returns an empty array if no words match", () => {
        ...
        verifyLookupResults(pd.lookupCode("nope"), []);
      });
    ...
    describe("lookupPrefix", () => {
      it("finds a word matching the prefix entirely", () => {
        ...
        verifyLookupResults(pd.lookupPrefix("ada"), ["ada"]);
      });
      ...
      it("finds a word where the code starts with the prefix", () => {
        ...
        verifyLookupResults(pd.lookupPrefix("ada"), ["adamant"]);
      });
      ...
      it("finds all words matching the prefix", () => {
        ...
        verifyLookupResults(pd.lookupPrefix("ada"), [
          "ada",
          "ADA",
          "AdA",
          "adamant",
      ...
      it("finds words added after initialization", () => {
        ...
        verifyLookupResults(pd.lookupPrefix("ada"), ["ada", "ADA", "adamant"]);
      });
      ...
      it("finds words added along an existing path", () => {
        ...
        verifyLookupResults(pd.lookupPrefix("ada"), ["ada", "adamant"]);
      });
      ...
      it("returns an empty array if no words match", () => {
        ...
        verifyLookupResults(pd.lookupPrefix("nope"), []);
      });

      it("ignores words where the code is the prefix of the prefix", () => {
        const pd = new PrefixDictionary(["ada", "a", "ad"], identity);
